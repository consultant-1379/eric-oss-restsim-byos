...
const charAdd = "abcdefghijklmnopqrstuvwxyz0123456789"
...
func Model_parser(path string) error {
	...
	err = dbutils.CreateTable(TarDb, []string{"uri", "body"}, []string{"varchar", "varchar"}, "uri")
	if err != nil {
		log.Fatal(err)
		return err
	}
	log.Println("Table created successfully", TarDb, DbName)
