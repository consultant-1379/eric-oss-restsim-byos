...
{{- define "eric-oss-byos-buildmanager.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-byos-buildmanager.mergeAnnotations" -}}
  {{- include "eric-oss-byos-buildmanager.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-oss-byos-buildmanager.mergeLabels" -}}
  {{- include "eric-oss-byos-buildmanager.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
